...
export const USER_LOADING_REQUEST = "REGISTER_REQUEST";
export const USER_LOADING_SUCCESS = "REGISTER_SUCCESS";
export const USER_LOADING_FAILURE = "REGISTER_FAILURE";
...
export const POST_DELETE_SUCCESS = "POST_UPLOAD_SUCCESS";
